...
# version ='1.0'
# Description: From bluff body own coding input (4 digit) creates a general bluff body geometry
...
class generateBluffBody(object):
    def __init__ (self, bluff_code, caseDir):
    ...
    def generateVertices(self):
        ...
        if self.AoA != 0:
            if int(self.shape) != 1 or self.y_ref_length != 5:
                ...
                # Rotar cada punto del contorno de la figura
...
for i in range(1,4,1):
    bluff_code = f"{i}551"
    my_bluff_body = generateBluffBody(bluff_code)
    my_bluff_body.generateVertices()
    my_bluff_body.plotVertices()
"""

bluff_code = "30500"
my_bluff_body = generateBluffBody(bluff_code,'C:/Users/USUARIO/Desktop/Uni/Master/OUTGOING/Erasmus/Q2/Thesis')
my_bluff_body.generateVertices()
